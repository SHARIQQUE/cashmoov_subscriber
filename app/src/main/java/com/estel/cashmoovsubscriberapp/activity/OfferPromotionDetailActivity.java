...
public class OfferPromotionDetailActivity extends AppCompatActivity {
    ...
    private TextView txt_header,txt_content,txt_name,txt_title,txt_time,txt_term_condition,txt_view_more,txt_terms_one,txt_terms_two;
    ...
    private void setBackMenu() {
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyApplication.hideKeyboard(OfferPromotionDetailActivity.this);
                onSupportNavigateUp();
            }
        });
