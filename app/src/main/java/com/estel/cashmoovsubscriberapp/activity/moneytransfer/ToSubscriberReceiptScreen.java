...
public class ToSubscriberReceiptScreen extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getIds() {
        ...
        tvTransAmount.setText(ToSubscriberConfirmScreen.receiptJson.optJSONObject("walletTransfer").optString("desCurrencySymbol")+" "+ MyApplication.addDecimal(ToSubscriberConfirmScreen.tvTransAmount.getText().toString()));
        ...
        tvAmountCharged.setText(ToSubscriberConfirmScreen.receiptJson.optJSONObject("walletTransfer").optString("srcCurrencySymbol")+" "+MyApplication.addDecimal(ToSubscriberConfirmScreen.receiptJson.optJSONObject("walletTransfer").optString("value")));
        ...
        if(ToSubscriberConfirmScreen.taxConfigList!=null){
            if(ToSubscriberConfirmScreen.taxConfigList.length()==1){
                ...
                tax1_value.setText(ToSubscriberConfirmScreen.receiptJson.optJSONObject("walletTransfer").optString("srcCurrencySymbol")+" "+MyApplication.addDecimal(ToSubscriberConfirmScreen.taxConfigList.optJSONObject(0).optString("value")));
            ...
            if(ToSubscriberConfirmScreen.taxConfigList.length()==2){
                ...
                tax2_value.setText(ToSubscriberConfirmScreen.receiptJson.optJSONObject("walletTransfer").optString("srcCurrencySymbol")+" "+MyApplication.addDecimal(ToSubscriberConfirmScreen.taxConfigList.optJSONObject(1).optString("value")));
