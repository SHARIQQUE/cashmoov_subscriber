...
public class SelfAirtimeConfirm extends LogoutAppCompactActivity implements View.OnClickListener {
...
//    }
    ...
    private void getIds() {
        ...
        tvAmountCharged.setText(SelfAirtime.currencySymbol+" "+MyApplication.addDecimal(String.valueOf(finalamount)));
