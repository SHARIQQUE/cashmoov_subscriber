...
public class BillPayReceipt extends LogoutAppCompactActivity implements View.OnClickListener {
...
//        tvAmountCharged.setText(BillPay.currencySymbol+" "+MyApplication.addDecimal(BillPayConfirmScreen.receiptJson.optJSONObject("remittance").optString("amount")));
        ...
        if(BillPayConfirmScreen.taxConfigList!=null){
            if(BillPayConfirmScreen.taxConfigList.length()==1){
                ...
                tax1_lable.setText(MyApplication.getTaxString(BillPayConfirmScreen.taxConfigList.optJSONObject(0).optString("taxTypeName")));
            ...
            if(BillPayConfirmScreen.taxConfigList.length()==2){
                ...
                tax2_lable.setText(MyApplication.getTaxString(BillPayConfirmScreen.taxConfigList.optJSONObject(1).optString("taxTypeName")));
