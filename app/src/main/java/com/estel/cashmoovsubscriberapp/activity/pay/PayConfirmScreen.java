...
//    }
    ...
    private void getIds() {
        ...
        tvAmountPaid.setText(Pay.currencySymbol+" "+ MyApplication.addDecimal(String.valueOf(Pay.currencyValue)));
        tvFee.setText(Pay.fromCurrencySymbol+" "+MyApplication.addDecimal(String.valueOf(Pay.fee)));

       finalamount=Double.parseDouble(String.valueOf(Pay.fee))+Double.parseDouble(Pay.etAmount.getText().toString());
        ...
        if(Pay.taxConfigurationList!=null){
            if(Pay.taxConfigurationList.length()==1){
                ...
                finalamount=Double.parseDouble(String.valueOf(Pay.fee))+Double.parseDouble(Pay.etAmount.getText().toString())+Double.parseDouble(Pay.taxConfigurationList.optJSONObject(0).optString("value"));
            }
            if(Pay.taxConfigurationList.length()==2){
                ...
                finalamount=Double.parseDouble(String.valueOf(Pay.fee))+Double.parseDouble(Pay.etAmount.getText().toString())+Double.parseDouble(Pay.taxConfigurationList.optJSONObject(0).optString("value"))+Double.parseDouble(Pay.taxConfigurationList.optJSONObject(0).optString("value"));
            }
        }
