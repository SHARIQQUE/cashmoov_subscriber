...
public class InFormConfirmation extends LogoutAppCompactActivity implements View.OnClickListener {
...
//    }
    ...
    public void callPostAPI(){
        MyApplication.showloader(InFormConfirmation.this,getString(R.string.please_wait));
